...
import os, sys, traceback, time, struct, socket, random, hashlib, hmac, random, gateway, p2psip
from rtmplite import amf 
...
#            self.writeMessage(m1)
            ...
            def onStreamTransfer(self, stream, cmd):
